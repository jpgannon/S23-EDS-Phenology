...
```{r tab5}
tab5 <- tabPanel("*Time Series",
                 fluid = TRUE,
                 mainPanel(
                     h4("... time series plot", align = "center"),
                   )
)
```

```{r tab6}
tab6 <- tabPanel("*Bivariate",
                 fluid = TRUE,
                 mainPanel(
                     h4("... bivariate / climate data plot", align = "center"),
                   )
)
```
...
overview <- tabPanel("Overview", 
                     ...
                     img(src = 'SmokyMountains1.jpg', align = 'right'),
                     
                     h1("Introduction", style = "font-family:'times'; color:green"),
                     h3("Great Smoky Mountains National Park", style = "font-family:'times'"),
...
my_theme <- bs_theme(bootswatch = "darkly",
                     base_font = font_google("Space Mono")) ##"Righteous"
...
server <- function(input, output, session) {
  ...
  output$plot4 <- renderPlot({
    hist(
      ...
      xlab = 'Day of Year',
      main = 'Distribution of how many indivs. of a species have falling leaves by DOY',
      breaks = 365,
      xlim=c(0,365),
      col = 'blue',
      border = 'blue'
